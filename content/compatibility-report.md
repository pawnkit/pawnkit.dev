...
The July 29 preview set passed the PawnKit workflow on Linux, Windows, and
macOS. It is the current set used by the official Actions and editor tooling.
...
`pawn-corpus`. The workflow covered validation, formatting, linting, tests, and
the packaged build and run adapters. Archive installation also passed on
...
- Real-server integration is not part of this preview set.
