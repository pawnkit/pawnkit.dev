...
| --- | --- |
| PawnKit CLI | 1.34.20 |
| Pawn formatter | 1.4.9 |
| Pawn linter | 1.8.37 |
| Pawn language server | 0.34.15 |
| Pawn test runner | 1.2.11 |

The exact commits, release archives, sizes, and SHA-256 hashes are in the
[release set](/release-sets/toolchain-signed-2026-08-03-6.json).
...
See the [successful smoke and verification run](https://github.com/pawnkit/pawn-actions/actions/runs/30782581327)
