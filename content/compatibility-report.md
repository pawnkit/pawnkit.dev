...
[release set](/release-sets/toolchain-signed-2026-08-03-15.json).
...
See the [successful smoke and verification run](https://github.com/pawnkit/pawn-actions/actions/runs/30796801626)
