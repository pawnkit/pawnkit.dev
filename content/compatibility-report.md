...
The August 1 signed set passed the PawnKit workflow on Linux, Windows, and
...
See the [successful Actions run](https://github.com/pawnkit/pawn-actions/actions/runs/30701368420)
