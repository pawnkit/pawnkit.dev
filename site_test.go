...
func TestBuildAndSearchIndex(t *testing.T) {
	...
	assertContains(t, "dist/guides/compatibility-report.html", "toolchain-signed-2026-08-03-19.json")
	assertContains(t, "dist/guides/compatibility-report.html", "actions/runs/30805203050")
	...
	releaseSet, err := os.ReadFile(filepath.Join("dist", "release-sets", "toolchain-signed-2026-08-03-19.json"))
	if err != nil {
		t.Fatal(err)
	}
